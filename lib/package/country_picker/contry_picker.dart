import 'package:apex_task/package/country_picker/country_picker_modal.dart';
...
const kBorderRadius = Radius.circular(40);
...
/// {@endtemplate}
class KFlCountryCodePicker {
  /// {@macro fl_country_code_picker}
  const KFlCountryCodePicker({
  ...
  Future<CountryCode?> showPicker({
    ...
    final country = showModalBottomSheet<CountryCode?>(
      ...
      builder: (_) => KCountryCodePickerModal(
        favorites: favorites,
